  ...
  render () {
    ...
    return (
      ...
      <div class="mb-xl">
        ...
        <p class="typography-subheading">The basic idea behind this prototype is to store the right to be forgotten setting for personal data management <a href="http://seahorse.alvis.io" target="_blank" class="text-info">Seahorse<sup><i class="material-icons material-icons-inline">open_in_new</i></sup></a>.</p>
      </div>
